...
export default function MonsterPage() {
  ...
  const monsterData = useMonsters(monsterIndexArray, debouncedSearchTerm, currentPage, monstersPerPage, false) as UseQueryResult<MonsterCardDataProps, Error>[];
  ...
  const filteredMonsters = useMemo(() => 
    ...
    [monsterIndexArray, debouncedSearchTerm]
  );
  ...
  return (
    <div className="bg-madmage bg-center bg-cover bg-no-repeat min-h-screen flex flex-col items-center justify-center">
      ...
      <div
        className={`bg-customGray bg-opacity-80 p-8 rounded-lg shadow-lg w-2/3 tablet:w-10/12 h-auto flex flex-col items-center justify-center mt-10 mb-10 ${isLoading ? 'hidden' : ''}`}
