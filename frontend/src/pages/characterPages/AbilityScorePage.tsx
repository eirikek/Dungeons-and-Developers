...
export default function AbilityScorePage(){
  return (
    <>
      <Navbar />
      <section className="relative flex items-center justify-center h-screen z-0 before:absolute before:inset-0 before:bg-bluedrake before:bg-cover before:bg-center before:animate-background-zoom  before:z-0">
