    ...
    <>
      <section className="flex flex-col justify-center w-3/4 rounded space-y-10">
        <article
          ...
          <img src={dragonborn} alt="dragonborn" className="max-w-60 border-none shadow-none"/>
        ...
        <article
          className="flex flex-row gap-5 items-center p-8 rounded-lg ">
          <img src={dwarf} alt="dwarf" className="max-w-60 border-none shadow-none"/>
        ...
        <article
          className="flex flex-row gap-5 items-center p-8 rounded-lg ">
          <img src={elf} alt="elf" className="max-w-60 border-none shadow-none"/>
        ...
        <article
          className="flex flex-row gap-5 items-center p-8 rounded-lg ">
          <img src={gnome} alt="gnome" className="max-w-60 border-none shadow-none"/>
        ...
        <article
          className="flex flex-row gap-5 items-center p-8 rounded-lg ">
          <img src={half_elf} alt="half elf" className="max-w-60 border-none shadow-none"/>
        ...
        <article
          className="flex flex-row gap-5 items-center p-8 rounded-lg ">
          <img src={half_orc} alt="half orc" className="max-w-60 border-none shadow-none"/>
        ...
        <article
          className="flex flex-row gap-5 items-center p-8 rounded-lg ">
          <img src={halfling} alt="halfling" className="max-w-60 border-none shadow-none" />
        ...
        <article
          className="flex flex-row gap-5 items-center p-8 rounded-lg ">
          <img src={human} alt="human" className="max-w-60 border-none shadow-none" />
        ...
        <article
          className="flex flex-row gap-5 items-center p-8 rounded-lg ">
          <img src={tiefling} alt="tiefling" className="max-w-60 border-none shadow-none"/>
