    ...
    <>
      <section className="flex flex-col justify-center w-3/4 rounded space-y-10">
        <article
          ...
          <img src ={barbarian} alt="barbarian" className="max-w-60 border-none shadow-none"/>
        ...
        <article
          className="flex flex-row gap-5 items-center p-8 rounded-lg ">
          <img src={bard} alt="bard" className="max-w-60 border-none shadow-none" />
        ...
        <article
          className="flex flex-row gap-5 items-center p-8 rounded-lg ">
          <img src={cleric} alt="cleric" className="max-w-60 border-none shadow-none" />
        ...
        <article
          className="flex flex-row gap-5 items-center p-8 rounded-lg ">
          <img src={druid} alt="druid" className="max-w-60 border-none shadow-none"/>
        ...
        <article
          className="flex flex-row gap-5 items-center p-8 rounded-lg ">
          <img src={fighter} alt="fighter" className="max-w-60 border-none shadow-none" />
        ...
        <article
          className="flex flex-row gap-5 items-center p-8 rounded-lg ">
          <img src={monk} alt="monk" className="max-w-60 border-none shadow-none"/>
        ...
        <article
          className="flex flex-row gap-5 items-center p-8 rounded-lg ">
          <img src={paladin} alt="bard" className="max-w-60 border-none shadow-none"/>
        ...
        <article
          className="flex flex-row gap-5 items-center p-8 rounded-lg ">
          <img src={ranger} alt="ranger" className="max-w-60 border-none shadow-none"/>
        ...
        <article
          className="flex flex-row gap-5 items-center p-8 rounded-lg ">
          <img src={rogue} alt="rogue" className="max-w-60 border-none shadow-none"/>
        ...
        <article
          className="flex flex-row gap-5 items-center p-8 rounded-lg ">
          <img src={sorcerer} alt="sorcerer" className="max-w-60 border-none shadow-none"/>
        ...
        <article
          className="flex flex-row gap-5 items-center p-8 rounded-lg ">
          <img src={warlock} alt="warlock" className="max-w-60 border-none shadow-none" />
